...
function DropdownMenuTrigger({ className, children, ...props }: DropdownMenuTriggerProps) {
  ...
  return (
    <DropdownMenuPrimitive.Trigger
      ...
      {...props}
    >
      <span className='flex-1 overflow-hidden whitespace-nowrap text-ellipsis'>{children}</span>
...
function DropdownMenuItem({ className, color, ...props }: DropdownMenuItemProps) {
