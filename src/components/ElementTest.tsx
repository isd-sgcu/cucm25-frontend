  ...
  return (
    <Container className='flex flex-col gap-8'>
      ...
      <div className='flex flex-col gap-8'>
        ...
        <div className='flex flex-col gap-6'>
          ...
          <div className='flex gap-4 flex-col flex-wrap'>
            <Button variant='default' size='xxl' color='light-blue' cartoonish={true}>
              <CardGiftcard fontSize='large' />
              <p className='title-medium'>แก้จำนวนของขวัญ</p>
            </Button>
            <div className='flex gap-2'>
              <Button variant='default' size='xl' color='light-pink' cartoonish={true}>
                <p className='title-medium'>สร้าง Coin รับ Code สำหรับพี่ค่าย</p>
              </Button>
              <Button variant='default' size='xl' color='yellow' cartoonish={true}>
                <p className='title-medium'>สร้าง Coin รับ Code สำหรับน้องค่าย</p>
              </Button>
            </div>
          </div>
        </div>
      ...
      <div className='flex flex-col gap-8'>
        ...
        <div className='flex flex-col gap-6'>
          <Input />
          <Input label='ระบุจำนวนเหรียญ' placeholder='000' type='number' inputSize={'xl'} min={1} />
          ...
          <div className='flex w-full items-center gap-4'>
            <Input label='Pin' inputSize={'sm'} maxLength={1} inputClassName='text-center' />
            <Input
      ...
      <div className='flex flex-col gap-8'>
        ...
        <div className='flex flex-col gap-4 items-end'>
            ...
            <DropdownMenuContent>
              <DropdownMenuGroup>
                {[
                  ...
                  <DropdownMenuItem key={item} onSelect={() => setFaculty(item)}>
                    {item}
                  </DropdownMenuItem>
                ))}
              </DropdownMenuGroup>
          ...
          <DropdownMenu size='sm' color='light-blue'>
            <DropdownMenuTrigger className='bg-light-blue'>{pn}</DropdownMenuTrigger>
            <DropdownMenuContent align='end'>
              <DropdownMenuGroup>
                {['P', 'N'].map(item => (
